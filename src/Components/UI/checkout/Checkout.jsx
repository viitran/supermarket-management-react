                ...
                <div className="row">
                  <div className="col-12 col-xl-6">
                    <div data-mdb-input-init className="form-outline mb-4 mb-xl-5">
                      ...
                      <label class="htmlForm-label" for="typeName">Name on card</label>
                    </div>

                    <div data-mdb-input-init className="form-outline mb-4 mb-xl-5">
                      <input type="text" id="typeExp" class="form-control form-control-lg" placeHolder="MM/YY"
                        size="7" minlength="7" maxLength="7" />
                      <label class="htmlForm-label" for="typeExp">Expiration</label>
                    </div>
                  </div>
                  <div className="col-12 col-xl-6">
                    <div data-mdb-input-init className="form-outline mb-4 mb-xl-5">
                      ...
                      <label class="htmlForm-label" for="typeText">Card Number</label>
                    </div>

                    <div data-mdb-input-init className="form-outline mb-4 mb-xl-5">
                      <input type="password" id="typeText" className="form-control form-control-lg"
                        placeholder="&#9679;&#9679;&#9679;" size="1" minlength="3" maxLength="3" />
                      <label class="htmlForm-label" for="typeText">Cvv</label>
                    </div>
                  </div>
                </div>
              </div>
